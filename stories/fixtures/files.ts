...
import { fileNames } from "@scripts/mocks/generate-files";

// NOTE: below json file was generated by running:
// `npx tsx scripts/mocks/generate-files.ts | jq . > stories/mocks/files.generated.json`
// to see decrypted content in terminal, run: `npx tsx scripts/mocks/read-files.ts | jq .`
