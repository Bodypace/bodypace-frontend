...
const document: DocumentPart[] = [
  [ DocumentPartType.Paragraph, "Last updated on: 2023-04-15"],
  [ DocumentPartType.Title,     "Privacy Policy"],
  ...
  [ DocumentPartType.Header,    "Information collection and use"],
  ...
  [ DocumentPartType.Header,    "Sharing of information"],
  ...
  [ DocumentPartType.Header,    "Security"],
  ...
  [ DocumentPartType.Header,    "Children"],
  ...
  [ DocumentPartType.Header,    "Changes to this privacy policy"],
  ...
  [ DocumentPartType.Header,    "Contact us"],
